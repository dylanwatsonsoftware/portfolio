...
- Install homebrew apps i.e brew install \<app\>:
  ...
  - maven
  - nvm
    - After installing nvm you will likely have to manually add something to your .zshrc (or your dot profile of choice) - Look for ia command in the logs
      ```
  ...
  - git
    ```
    brew install git
    git config --global user.email my.name@atlassian.com
